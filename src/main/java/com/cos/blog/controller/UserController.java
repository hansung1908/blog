...
public class UserController {
    ...
    public String kakaoCallback(String code) {   // @Responsebody를 붙히면 data를 리턴해주는 컨트롤러 함수가 됨.
        ...
        params.add("client_id", "46d0949bd3452f272861213f24e9fa60");
        params.add("redirect_uri", "http://localhost:8000/auth/kakao/callback");
        params.add("code", code);

        // HttpHeader와 HttpBody를 하나의 오브젝트에 담기, 이유는 exchange함수가 HttpEntity를 오브젝트로 받음.
        HttpEntity<MultiValueMap<String, String>> kakaoTokenRequest = new HttpEntity<>(params, headers);

        // Http 요청하기 - POST 방식 - 그리고 response변수의 응답을 받음
